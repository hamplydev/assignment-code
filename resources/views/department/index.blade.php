...
<div class="content">
  <div class="container-fluid">
    ...
    <div class="panel panel-inverse" style="margin-left: 15px;">
      <p class="pull-left">
        <a class="btn btn-success" href="{{ route('department.create') }}"><i class="icon-plus"></i> Add New</a>  
        <a class="btn btn-info" href="{{ route('department.export-excel') }}"> Excel </a>  
        <a class="btn btn-warning" href="{{ route('department.export-csv') }}"> CSV </a>
      </p>
    </div>
                  ...
                  <td style="width: 7%;">
                      <div class="dropdown">
                          ...
                          <div class="dropdown-menu">
                              <a class="dropdown-item" href="{{ route('department.edit', $item->id) }}"><i class="fa fa-edit"></i> Edit </a>
                              <a class="dropdown-item" href="" id="link_modal" data-toggle="modal" data-id="{{ $item->id }}" data-attr="{{ route('department.destroy', $item->id) }}" data-target="#modal-sm"> <i class="fa fa-trash"></i> Remove </a>
                              ...
                              <!-- <form action="{{ route('department.destroy',$item->id) }}" method="POST" >
                                        <a href="{{ route('department.show', $item->id) }}" class="dropdown-item"><i class="fa fa-eye"></i> Show</a>
                                        <a href="{{ route('department.edit', $item->id) }}" class="dropdown-item"><i class="fa fa-edit"></i> Edit</a>
                                            @csrf
                                            @method('DELETE')
