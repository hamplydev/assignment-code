  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index3.html" class="brand-link">
      ...
      <span class="brand-text font-weight-light">HR - TEST</span>
    </a>
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <a href="#" class="d-block">Hamply Sary</a>
        </div>
      </div>
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="{{ route('attendance.daily-presents') }}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Daily Present</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="{{ route('attendance.monthly-presents') }}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Monthly Present</p>
                </a>
              </li>
